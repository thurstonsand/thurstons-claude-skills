...
def init_skill(skill_name: str, path: str | Path) -> Path | None:
    ...
    try:
        _ = skill_md_path.write_text(skill_content)
    ...
    try:
        ...
        _ = example_script.write_text(EXAMPLE_SCRIPT.format(skill_name=skill_name))
        ...
        _ = example_reference.write_text(
        ...
        _ = example_asset.write_text(EXAMPLE_ASSET)
